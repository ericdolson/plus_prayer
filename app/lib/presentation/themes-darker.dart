...
final primaryColor = Color.fromRGBO(5, 128, 249, 1);
...
//   scaffoldBackgroundColor: const Color.fromRGBO(240, 236, 233, 1), // light beige
  textTheme: const TextTheme(
    bodyLarge: TextStyle(color: Color.fromRGBO(3, 66, 125, 1)),
    bodyMedium: TextStyle(color: Color.fromRGBO(3, 66, 125, 1)),
    bodySmall: TextStyle(color: Color.fromRGBO(3, 66, 125, 1)),
  ),
  appBarTheme: const AppBarTheme(
    systemOverlayStyle: SystemUiOverlayStyle(statusBarBrightness: Brightness.light),
    backgroundColor: Colors.transparent,
    titleTextStyle: TextStyle(color: Color.fromRGBO(3, 66, 125, 1), fontSize: 20),
    elevation: 0,
...
// onBackground: Colors.orange,
    ...
    surfaceBright: Color.fromRGBO(225, 231, 243, 1),
    onSurface: Color.fromRGBO(3, 66, 125, 1),
  ),
  ...
  bottomSheetTheme: BottomSheetThemeData(
      ...
      dragHandleColor: Color.fromRGBO(3, 66, 125, 1).withValues(alpha:.4)),
  switchTheme: SwitchThemeData(
    thumbColor: WidgetStateColor.resolveWith((states) {
      if (states.contains(WidgetState.selected)) {
        return Color.fromRGBO(245, 247, 253, 1);
      }
      return Color.fromRGBO(3, 66, 125, 1);
    }),
...
final darkTheme3 = ThemeData(
  ...
  scaffoldBackgroundColor: Color.fromRGBO(20, 22, 24, 1),
  // Darker background
...
// titleTextStyle: TextStyle(color: Colors.black),
  ...
  colorScheme: ColorScheme.dark(
    ...
    surfaceTint: Color.fromRGBO(28, 32, 35, 1),
    surfaceBright: Color.fromRGBO(8, 10, 12, 1),
  ...
  bottomSheetTheme: BottomSheetThemeData(
      modalBackgroundColor: Color.fromRGBO(20, 22, 24, 1), // Set the background color
  ...
  switchTheme: SwitchThemeData(
    thumbColor: WidgetStateColor.resolveWith((states) {
      if (states.contains(WidgetState.selected)) {
        return Color.fromRGBO(20, 22, 24, 1);
      }
